...
export default function Contact() {
  return (
    <section
      id="contact"
      className="py-20 px-6 bg-white dark:bg-neutral-950 transition duration-300"
    >
      {/* Header */}
      ...
      <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12">
        ...
        <div
          className="p-8 rounded-2xl bg-white dark:bg-neutral-900 shadow-lg 
        ...
        >
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="text-neutral-800 dark:text-neutral-300 text-sm">
          ...
          <div className="mt-10 flex items-center gap-5 flex-wrap">
            ...
            <a
              href="#"
              className="p-3 rounded-full bg-white/20 dark:bg-black/20 
    backdrop-blur-md shadow-sm border border-white/30 
    dark:border-neutral-700 hover:scale-110 transition"
            >
              <Facebook className="text-neutral-800 dark:text-neutral-200" />
            </a>
    ...
    dark:border-neutral-700 hover:scale-110 transition"
            >
              <Twitter className="text-neutral-800 dark:text-neutral-200" />
            </a>
    ...
    dark:border-neutral-700 hover:scale-110 transition"
            >
              <Linkedin className="text-neutral-800 dark:text-neutral-200" />
            </a>
    ...
    dark:border-neutral-700 hover:scale-110 transition"
            >
              <Instagram className="text-neutral-800 dark:text-neutral-200" />
            </a>
    ...
    dark:border-neutral-700 hover:scale-110 transition"
            >
              <Github className="text-neutral-800 dark:text-neutral-200" />
            </a>
        ...
        >
          ...
          <div className="space-y-5">
            <input
              ...
              text-neutral-800 dark:text-neutral-200 focus:ring-2 
